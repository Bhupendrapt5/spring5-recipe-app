...
import io.bhupedra.spring5recipeapp.services.IngredientService;
import io.bhupedra.spring5recipeapp.services.RecipeService;
import io.bhupedra.spring5recipeapp.services.UnitOfMeasureServiceImpl;
...
class IngredientControllerTest {
    ...
    void testIngredientDeleteAction() throws Exception {
        ...
        verify(ingredientService, times(1))
                .deleteIngredientById(anyLong(),anyLong());
    }
}